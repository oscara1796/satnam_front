...
const CalendarComponent = () => {
                ...
                {isLoading ? (
                    ...
                    <div className="row">
                        {eventData && eventData.length > 0 ? 
                            ...
                            :
                                <>
                                    <h3 className='text-center mt-4'> No hay horarios de momento </h3>
                                </>
                        }
                    </div>
                )}
  ...
  const ContactInfoComponent = () => {
    return (
      ...
      >
        <h2>Contáctenos</h2>
        <p><strong>Telefono:</strong> (33) 14183347</p>
        <p><strong>Domicilio:</strong> Plateros 2378 col. Jardines del Country, GDL, Jalisco, México</p>
        <p><strong>Contacto:</strong> Sandra López</p>
      </motion.div>
    );
  }
...
const GoogleMapComponent = () => {
    return (
      <div className="my-5  d-flex  justify-content-center"style={{ overflow: 'hidden', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)' }}>
        <iframe
