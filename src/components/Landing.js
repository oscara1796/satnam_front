              ...
              <Carousel.Item key={item.id}>
                <div className="carousel-image-container">
                  ...
                  <div className="carousel-caption">
                    <h1>{item.caption}</h1>
                    { props.isLoggedIn ? (<></>) : (<Button variant="outline-light">Inscríbite</Button>)}
                  </div>
                </div>
              </Carousel.Item>
            )
  ...
  const benefitItems= [
    {
      id:1,
      imageSrc: fuerte,
      caption: "Ejercicios físicos y mentales, equilibria tu cuerpo, tu mente y alma."
    },
    {
      id:2,
      imageSrc: cerebro,
      caption: "Purifica tu mente, elimina la basura mental y conócete a ti  mismo."
    },
    {
      id:3,
      imageSrc: brillar,
      caption: "Revitaliza tu energía, regenera tu cuerpo e integra nuevos y mejores hábitos."
    }
  ]
